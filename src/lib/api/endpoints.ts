...
const baseUrlMap = {
  room: import.meta.env.VITE_SERVER_HOST ?? "",
  participant: import.meta.env.VITE_SERVER_HOST ?? "",
  vote: import.meta.env.VITE_SERVER_HOST ?? "",
  sse: import.meta.env.VITE_SERVER_HOST ?? "",
  user: import.meta.env.VITE_SERVER_HOST ?? "",
  auth: import.meta.env.VITE_SERVER_HOST ?? "",
