...
import DraggableBlockPlugin from "@/app/plugins/DraggableBlockPlugin";
import { PreserveSelectionPlugin } from "@/app/plugins/PreserveSelectionPlugin";
              ...
              <div className="xl:mr-[200px]">
                <div className="relative max-w-[740px] w-full mx-auto pb-[400px] p-8">
                  <div className="absolute left-full -ml-8">
                    ...
                    {threads ? (
                      <AnchoredThreads threads={threads} className="w-[270px] hidden xl:block" />
                    ) : null}
                  </div>
